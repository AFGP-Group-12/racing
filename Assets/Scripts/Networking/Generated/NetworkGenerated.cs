...
namespace Messages
{
    ...
    unsafe class Helpers {
        ...
        const float pos_acc_factor = Int32.MaxValue;
        public static void fillPosition(Vector3 pos, Vector3 max_bounds, out position_sm m) {            
            m.x = (Int32)(pos.x * (pos_acc_factor / max_bounds.x));
            m.y = (Int32)(pos.y * (pos_acc_factor / max_bounds.y));
            m.z = (Int32)(pos.z * (pos_acc_factor / max_bounds.z));
        }
	...
	public unsafe struct request_last_position_m_reply
	{
		...
		[FieldOffset(16)] public byte was_found;
	};
	...
	public unsafe struct navmesh_data_m
	{
		...
		[FieldOffset(4)] public fixed byte node_positions[15 * position_sm.size];
		[FieldOffset(184)] public fixed byte node_types[15];
	};
	...
	public unsafe struct movement_m
	{
		...
		[FieldOffset(4)] public position_sm position;
		[FieldOffset(16)] public position_sm velocity;
		[FieldOffset(28)] public UInt16 rotation;
		[FieldOffset(30)] public UInt16 timestamp;
		[FieldOffset(32)] public UInt16 state;
	};
	...
	public unsafe struct connection_m_reply
	{
		...
		[FieldOffset(4)] public position_sm position;
		[FieldOffset(16)] public UInt16 id;
	};
